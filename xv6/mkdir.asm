...
printint(int fd, int xx, int base, int sgn)
{
 ...
 459:	0f b6 91 ac 08 00 00 	movzbl 0x8ac(%ecx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 593:	75 25                	jne    5ba <printf+0xff>
          s = "(null)";
 595:	c7 45 f4 a5 08 00 00 	movl   $0x8a5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 65c:	a1 c8 08 00 00       	mov    0x8c8,%eax
 ...
 727:	a3 c8 08 00 00       	mov    %eax,0x8c8
}
 72c:	90                   	nop
 72d:	c9                   	leave  
 72e:	c3                   	ret    
