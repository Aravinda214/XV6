...
free(void *ap)
{
 ...
 691:	a1 80 0a 00 00       	mov    0xa80,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 80 0a 00 00    	mov    %edx,0xa80
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 80 0a 00 00    	mov    %edx,0xa80
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 777:	73 4f                	jae    7c8 <malloc+0xa8>
    ...
    if(p == freep)
 779:	8b 3d 80 0a 00 00    	mov    0xa80,%edi
 ...
 7a2:	e8 e9 fe ff ff       	call   690 <free>
  return freep;
 7a7:	a1 80 0a 00 00       	mov    0xa80,%eax
 ...
 7d4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7d7:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 ...
 7ee:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 7f7:	0a 00 00 
    base.s.size = 0;
 7fa:	bf 84 0a 00 00       	mov    $0xa84,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 806:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 80b:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 812:	00 00 00 
    if(p->s.size >= nunits){
