...
free(void *ap)
{
 ...
 671:	a1 7c 08 00 00       	mov    0x87c,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 7c 08 00 00    	mov    %edx,0x87c
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 7c 08 00 00    	mov    %edx,0x87c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d 7c 08 00 00    	mov    0x87c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 757:	73 4f                	jae    7a8 <malloc+0xa8>
    ...
    if(p == freep)
 759:	8b 3d 7c 08 00 00    	mov    0x87c,%edi
 ...
 782:	e8 e9 fe ff ff       	call   670 <free>
  return freep;
 787:	a1 7c 08 00 00       	mov    0x87c,%eax
 ...
 7b4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 7b7:	a3 7c 08 00 00       	mov    %eax,0x87c
}
 ...
 7ce:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 7c 08 00 00 80 	movl   $0x880,0x87c
 7d7:	08 00 00 
    base.s.size = 0;
 7da:	bf 80 08 00 00       	mov    $0x880,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 80 08 00 00 80 	movl   $0x880,0x880
 7e6:	08 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7eb:	c7 05 84 08 00 00 00 	movl   $0x0,0x884
 7f2:	00 00 00 
    if(p->s.size >= nunits){
