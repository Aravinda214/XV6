...
free(void *ap)
{
 ...
 601:	a1 e8 07 00 00       	mov    0x7e8,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 e8 07 00 00    	mov    %edx,0x7e8
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 e8 07 00 00    	mov    %edx,0x7e8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d e8 07 00 00    	mov    0x7e8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e7:	73 4f                	jae    738 <malloc+0xa8>
    ...
    if(p == freep)
 6e9:	8b 3d e8 07 00 00    	mov    0x7e8,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 e8 07 00 00       	mov    0x7e8,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 e8 07 00 00       	mov    %eax,0x7e8
}
 ...
 75e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 e8 07 00 00 ec 	movl   $0x7ec,0x7e8
 767:	07 00 00 
    base.s.size = 0;
 76a:	bf ec 07 00 00       	mov    $0x7ec,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 ec 07 00 00 ec 	movl   $0x7ec,0x7ec
 776:	07 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 f0 07 00 00 00 	movl   $0x0,0x7f0
 782:	00 00 00 
    if(p->s.size >= nunits){
