...
free(void *ap)
{
 ...
 5e1:	a1 a8 07 00 00       	mov    0x7a8,%eax
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	89 15 a8 07 00 00    	mov    %edx,0x7a8
}
 628:	5e                   	pop    %esi
 629:	5f                   	pop    %edi
 62a:	5d                   	pop    %ebp
 ...
 659:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 65c:	89 15 a8 07 00 00    	mov    %edx,0x7a8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 3d a8 07 00 00    	mov    0x7a8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6c7:	73 4f                	jae    718 <malloc+0xa8>
    ...
    if(p == freep)
 6c9:	8b 3d a8 07 00 00    	mov    0x7a8,%edi
 ...
 6f2:	e8 e9 fe ff ff       	call   5e0 <free>
  return freep;
 6f7:	a1 a8 07 00 00       	mov    0x7a8,%eax
 ...
 724:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 727:	a3 a8 07 00 00       	mov    %eax,0x7a8
}
 ...
 73e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 a8 07 00 00 ac 	movl   $0x7ac,0x7a8
 747:	07 00 00 
    base.s.size = 0;
 74a:	bf ac 07 00 00       	mov    $0x7ac,%edi
    base.s.ptr = freep = prevp = &base;
 74f:	c7 05 ac 07 00 00 ac 	movl   $0x7ac,0x7ac
 756:	07 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 759:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 75b:	c7 05 b0 07 00 00 00 	movl   $0x0,0x7b0
 762:	00 00 00 
    if(p->s.size >= nunits){
