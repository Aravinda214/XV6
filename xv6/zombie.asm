...
free(void *ap)
{
 ...
 5b1:	a1 64 07 00 00       	mov    0x764,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 64 07 00 00    	mov    %edx,0x764
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 64 07 00 00    	mov    %edx,0x764
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 64 07 00 00    	mov    0x764,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 697:	73 4f                	jae    6e8 <malloc+0xa8>
    ...
    if(p == freep)
 699:	8b 3d 64 07 00 00    	mov    0x764,%edi
 ...
 6c2:	e8 e9 fe ff ff       	call   5b0 <free>
  return freep;
 6c7:	a1 64 07 00 00       	mov    0x764,%eax
 ...
 6f4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 6f7:	a3 64 07 00 00       	mov    %eax,0x764
}
 ...
 70e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 64 07 00 00 68 	movl   $0x768,0x764
 717:	07 00 00 
    base.s.size = 0;
 71a:	bf 68 07 00 00       	mov    $0x768,%edi
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 68 07 00 00 68 	movl   $0x768,0x768
 726:	07 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 729:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 72b:	c7 05 6c 07 00 00 00 	movl   $0x0,0x76c
 732:	00 00 00 
    if(p->s.size >= nunits){
