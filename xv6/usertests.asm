...
00000120 <iputtest>:
{
  ...
  printf(stdout, "iput test\n");
     ...
     12b:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "chdir / failed\n");
     ...
     1bf:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "unlink ../iputdir failed\n");
     ...
     1d6:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "chdir iputdir failed\n");
     ...
     1ed:	ff 35 50 55 00 00    	push   0x5550
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 50 55 00 00    	push   0x5550
     ...
     2a0:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 50 55 00 00    	push   0x5550
    ...
    exit();
     ...
     2ce:	ff 35 50 55 00 00    	push   0x5550
     ...
     2e5:	ff 35 50 55 00 00    	push   0x5550
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 50 55 00 00    	push   0x5550
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 50 55 00 00    	push   0x5550
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 50 55 00 00    	push   0x5550
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 50 55 00 00    	push   0x5550
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 50 55 00 00    	push   0x5550
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 50 55 00 00    	push   0x5550
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 50 55 00 00    	push   0x5550
     ...
     5de:	ff 35 50 55 00 00    	push   0x5550
     ...
     5f7:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 50 55 00 00    	push   0x5550
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 50 55 00 00    	push   0x5550
     ...
     793:	ff 35 50 55 00 00    	push   0x5550
     ...
     7aa:	ff 35 50 55 00 00    	push   0x5550
     ...
     7c3:	ff 35 50 55 00 00    	push   0x5550
     ...
     7de:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 50 55 00 00    	push   0x5550
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 50 55 00 00    	push   0x5550
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 50 55 00 00    	push   0x5550
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 50 55 00 00    	push   0x5550
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 50 55 00 00    	push   0x5550
     9e1:	e8 4a 30 00 00       	call   3a30 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 54 55 00 00       	push   $0x5554
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 50 55 00 00    	push   0x5550
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a6f:	56                   	push   %esi
     a70:	68 a0 7c 00 00       	push   $0x7ca0
     ...
     a95:	38 90 a0 7c 00 00    	cmp    %dl,0x7ca0(%eax)
  ...
  seq = 0;
    ...
    close(fds[0]);
     ...
     aeb:	83 c0 01             	add    $0x1,%eax
        buf[i] = seq++;
     aee:	88 90 9f 7c 00 00    	mov    %dl,0x7c9f(%eax)
      for(i = 0; i < 1033; i++)
     ...
     b09:	68 a0 7c 00 00       	push   $0x7ca0
...
00000bb0 <preempt>:
{
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c5b:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < 2; i++){
    ...
    10c8:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    10e3:	0f be 88 a0 7c 00 00 	movsbl 0x7ca0(%eax),%ecx
  ...
  printf(1, "fourfiles ok\n");
    ...
    118b:	68 a0 7c 00 00       	push   $0x7ca0
    ...
    11a0:	68 a0 7c 00 00       	push   $0x7ca0
    11a5:	56                   	push   %esi
...
00001440 <unlinkread>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    14f1:	68 a0 7c 00 00       	push   $0x7ca0
    14f6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    1508:	80 3d a0 7c 00 00 68 	cmpb   $0x68,0x7ca0
    150f:	75 6b                	jne    157c <unlinkread+0x13c>
  if(write(fd, buf, 10) != 10){
    1511:	83 ec 04             	sub    $0x4,%esp
    1514:	6a 0a                	push   $0xa
    1516:	68 a0 7c 00 00       	push   $0x7ca0
    151b:	53                   	push   %ebx
...
000015d0 <linktest>:
{
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a4:	68 a0 7c 00 00       	push   $0x7ca0
    16a9:	50                   	push   %eax
...
00001d20 <subdir>:
{
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e16:	68 a0 7c 00 00       	push   $0x7ca0
    1e1b:	50                   	push   %eax
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    1e2d:	80 3d a0 7c 00 00 66 	cmpb   $0x66,0x7ca0
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f15:	68 a0 7c 00 00       	push   $0x7ca0
    1f1a:	50                   	push   %eax
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    244e:	53                   	push   %ebx
    244f:	68 a0 7c 00 00       	push   $0x7ca0
    2454:	50                   	push   %eax
    ...
    2464:	53                   	push   %ebx
    2465:	68 a0 7c 00 00       	push   $0x7ca0
    246a:	56                   	push   %esi
...
000024e0 <bigfile>:
{
  ...
  for(i = 0; ; i++){
    ...
    259d:	0f be 05 a0 7c 00 00 	movsbl 0x7ca0,%eax
    25a4:	d1 fa                	sar    %edx
    25a6:	39 d0                	cmp    %edx,%eax
    25a8:	75 6e                	jne    2618 <bigfile+0x138>
    25aa:	0f be 15 cb 7d 00 00 	movsbl 0x7dcb,%edx
  ...
  for(i = 0; ; i++){
    ...
    25c6:	68 a0 7c 00 00       	push   $0x7ca0
    25cb:	56                   	push   %esi
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 50 55 00 00    	push   0x5550
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 50 55 00 00    	push   0x5550
    ...
    303e:	ff 35 50 55 00 00    	push   0x5550
    ...
    3059:	ff 35 50 55 00 00    	push   0x5550
    ...
    3073:	ff 35 50 55 00 00    	push   0x5550
    ...
    3092:	ff 35 50 55 00 00    	push   0x5550
    ...
    30a9:	ff 35 50 55 00 00    	push   0x5550
    ...
    30c0:	ff 35 50 55 00 00    	push   0x5550
    ...
    30d7:	ff 35 50 55 00 00    	push   0x5550
    ...
    30ee:	ff 35 50 55 00 00    	push   0x5550
    ...
    311d:	ff 35 50 55 00 00    	push   0x5550
    ...
    3134:	ff 35 50 55 00 00    	push   0x5550
    ...
    314b:	ff 35 50 55 00 00    	push   0x5550
    ...
    3162:	ff 35 50 55 00 00    	push   0x5550
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 50 55 00 00    	push   0x5550
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 50 55 00 00    	push   0x5550
    ...
    322b:	ff 35 50 55 00 00    	push   0x5550
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 50 55 00 00    	push   0x5550
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    325f:	90                   	nop
    if(uninit[i] != '\0'){
    3260:	80 b8 80 55 00 00 00 	cmpb   $0x0,0x5580(%eax)
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 50 55 00 00    	push   0x5550
    ...
    3293:	ff 35 50 55 00 00    	push   0x5550
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 a0 9c 00 00 	movl   $0x5400,0x9ca0(,%eax,4)
    3317:	00 54 00 00 
    ...
    332a:	ff 35 50 55 00 00    	push   0x5550
    args[MAXARG-1] = 0;
    3330:	c7 05 1c 9d 00 00 00 	movl   $0x0,0x9d1c
    3337:	00 00 00 
    printf(stdout, "bigarg test\n");
    ...
    333f:	58                   	pop    %eax
    3340:	5a                   	pop    %edx
    3341:	68 a0 9c 00 00       	push   $0x9ca0
    ...
    3357:	ff 35 50 55 00 00    	push   0x5550
    ...
    3387:	ff 35 50 55 00 00    	push   0x5550
    ...
    339e:	ff 35 50 55 00 00    	push   0x5550
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    347a:	68 a0 7c 00 00       	push   $0x7ca0
    347f:	57                   	push   %edi
...
00003660 <rand>:
  randstate = randstate * 1664525 + 1013904223;
    3660:	69 05 4c 55 00 00 0d 	imul   $0x19660d,0x554c,%eax
    3667:	66 19 00 
    366a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    366f:	a3 4c 55 00 00       	mov    %eax,0x554c
}
    3674:	c3                   	ret    
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c01:	a1 20 9d 00 00       	mov    0x9d20,%eax
{
  ...
  freep = p;
    ...
    3c41:	5b                   	pop    %ebx
  freep = p;
    3c42:	89 15 20 9d 00 00    	mov    %edx,0x9d20
}
    3c48:	5e                   	pop    %esi
    3c49:	5f                   	pop    %edi
    3c4a:	5d                   	pop    %ebp
  ...
  freep = p;
    3c7c:	89 15 20 9d 00 00    	mov    %edx,0x9d20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3c9c:	8b 3d 20 9d 00 00    	mov    0x9d20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3ce9:	8b 3d 20 9d 00 00    	mov    0x9d20,%edi
  ...
  return freep;
    3d17:	a1 20 9d 00 00       	mov    0x9d20,%eax
    ...
    3d44:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    3d47:	a3 20 9d 00 00       	mov    %eax,0x9d20
}
    ...
    base.s.ptr = freep = prevp = &base;
    3d60:	c7 05 20 9d 00 00 24 	movl   $0x9d24,0x9d20
    3d67:	9d 00 00 
    base.s.size = 0;
    3d6a:	bf 24 9d 00 00       	mov    $0x9d24,%edi
    base.s.ptr = freep = prevp = &base;
    3d6f:	c7 05 24 9d 00 00 24 	movl   $0x9d24,0x9d24
    3d76:	9d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3d79:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    3d7b:	c7 05 28 9d 00 00 00 	movl   $0x0,0x9d28
    3d82:	00 00 00 
    if(p->s.size >= nunits){
